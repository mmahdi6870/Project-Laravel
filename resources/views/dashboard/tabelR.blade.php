            ...
            <!-- Begin Page Content -->
                <div class="container-fluid ">
                    ...
                    <div class="row gx-0">
                        <div class="col-lg-6">
                            <form action="/tabelR" class="d-none d-sm-inline-block form-inline  navbar-search">
                                @csrf
                                ...
                                <table class="table table-bordered text-white" id="dataTable" width="100%" cellspacing="0">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th>Nama</th>
                                            <th>Bahan Sepatu</th>
                                            <th>Warna Sepatu Pudar</th>
                                            <th>Sol Sepatu Bewarna Kekuningan</th>
                                            <th>Ingin Menganti warna Sepatu</th>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            <td > 
                                                <form action="/tabelR/hapus/{{ $isi->id }}" method="POST" class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <button class="badge bg-dark border-0" onclick="return confirm('Apakah Kamu Yakin?')"><i class="fas fa-trash-alt"></i></button>
                                                    </form>
                                            </td>
